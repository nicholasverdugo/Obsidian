...
- Meeting with Sid and Moon
	...
	- ***Possible Schedule
		- August 8 to August 19:
			...
			- Gain access to a WiFi controller through Mesa or Taiwan ZCom office - ask for Alston's help with this
			- Ask Moon for assistance with the development environment
		- August 22 to September 9:
			- Study to propose an implementation strategy and detail 